...
class Entrance(commands.Cog):
    ...
    def load_data(self):
        ...
        V3.8.1: No longer auto-creates JSON file - all data now lives in database.
        """
    ...
    def save_data(self):
        """Legacy save method - V3.8.1: No-op, all data now saved to database."""
        pass  # No longer writes to JSON file

    def reload_cache(self):
        """Reload entrance data cache (legacy, for backwards compatibility).
        V3.8.1: This cache is deprecated - all operations use database directly.
        """
